                                ...
                                <form method="pull" action="mainpage.jsp">
                                    ...
                                    <select name="dept" style="color:black;" onchange="submit()">
                                        ...
                                        <%
                                            while(rs.next())
                                            {
                                        %><option style="color:black;" value="<%out.print(rs.getString(1).trim());%>" <%if(request.getParameter("dept")==null){}
                                        else if(request.getParameter("dept").equals(rs.getString(1))){out.println("selected");}%>><%out.println(rs.getString(2));%></option>
                                           <% }
                                        %>
                                    </select>
                                </form>
                                    ...
                                    %><select name="job_id" style="color:black;" required="">
                                            ...
                                            while(rs.next())
                                            {
                                                %><option style="color:black;" value="<%out.print(rs.getString(1));%>"><%out.print(rs.getString(2));%></option>
                                            <%}
                                            %></select>
                                            <br>
