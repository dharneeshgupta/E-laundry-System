...
else
{
    ...
    {   
        ...
        ResultSet rs;
        rs=s.executeQuery("select *from services where bill_no="+s3+" and Status=\"P\" and Roll_no="+session.getAttribute("roll_no."));
        if(rs.next()==true)
        {
            ...
            s.execute("delete from services where bill_no="+s3);
