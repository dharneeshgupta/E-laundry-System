...
<% response.setHeader("Cache-Control","no-cache");
  ...
  Connection con=DriverManager.getConnection("jdbc:mysql://localhost/laundry_shop","root","");
...
else
{
    ...
    <html>
        ...
        <body style="padding:20px;"> 
            <% rs=s.executeQuery("select bill_no,s.Roll_no,DOS,Status,Total_due,Del_mode,Del_date,Mobile_No from services s,user u where u.Roll_no=s.Roll_no order by bill_no");%>
                                ...
                                <tbody>
                                    ...
                                    {%>
                                        <tr>
                                            ...
                                            <td style="width:150px; text-align: center;"><%out.println(rs.getString(7));%></td>
                                            <td style="width:150px; text-align: center;"><%out.println(rs.getString(8));%></td>
                                        </tr>
                                        <%}%>
                                </tbody>
                            </table>
